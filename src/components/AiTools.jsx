...
//                     <div key={index} className='p-8 m-4 max-w-xs rounded-lg  shadow-lg border border-gray-100 hover:-translate-y-1 transiton-all duration-300 cursor-pointer' onClick={()=>user && navigate(tool.path)}>
...
{/* <div className="relative group col-span-1 row-span-1 sm:col-span-3 sm:row-span-2">
            <img
            ...
            <span className="relative z-10 p-4 text-white text-lg font-semibold">Dev</span>
          </div> */}
          ...
          {aiToolsData.map((tool, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p
                  className={`text-white/90 ${tool.title === 'AIMatrix' ? 'text-3xl' : 'text-sm'
                    }`}
                >
                  {tool.description}
                </p>
